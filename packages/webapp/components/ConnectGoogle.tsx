  ...
  return (
    <div className={styles.container}>
      <div className={styles.card}>
        ...
        <h2 className={styles.title}>Connect Your Account</h2>
        <p className={styles.description}>
          To search your emails and calendar, you need to connect an account. 
          We only request read-only access and never store your personal data.
        </p>
        <ul className={styles.permissions}>
          <li>
            <span className={styles.permissionIcon}>📧</span>
            <span>Read-only access to Email</span>
          </li>
          <li>
            <span className={styles.permissionIcon}>📅</span>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          <button
            ...
            disabled={loading}
            className={styles.button}
            style={{ background: '#2F2F2F', marginTop: '0' }}
          >
            {loading ? (
              <span className={styles.spinner} />
            ) : (
              <>
                <svg className={styles.googleIcon} viewBox="0 0 23 23">
